...
class RecipeView extends View {
  ...
  addHandlerRender(handler) {
    //Event Listners for load and hash change to render recipe
  ...
  addHanlerServings(handler) {
    this._parentElement.addEventListener('click', function (e) {
      ...
      if (!btn) return;
      const newServings = +btn.dataset.updateserving;
    ...
    <div class="recipe__details">
      ...
      <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
          <button class="btn--tiny btn--increase-servings" data-updateserving="${
      ...
      <button class="btn--round btn--bookmark">
        <svg class="">
          <use href="${iconSvg}#icon-bookmark${
